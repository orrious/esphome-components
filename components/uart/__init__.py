...
UART_MODES = {
    "UART": UARTMode.UART_CONFIG_MODE_UART,
    "RS485_HD": UARTMode.UART_CONFIG_MODE_RS485_HALF_DUPLEX,
    "IRDA": UARTMode.UART_CONFIG_MODE_IRDA,
    "RS485_CD": UARTMode.UART_CONFIG_MODE_RS485_COLLISION_DETECT,
    "RS485_AC": UARTMode.UART_CONFIG_MODE_RS485_APP_CTRL,
}
